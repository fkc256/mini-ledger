...
from ledger.repository import load_transactions, save_transactions # 데이터 
from ledger.services import calc_summary, calc_category_expense #값 더하기, 지출 비용 계산 
...
if st.sidebar.button("등록"):
    category_n = normalize_text(category) # 공백제거 및 영어대문자는 소문자로 치환
